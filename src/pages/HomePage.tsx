...
const HomePage = () => {
  ...
  return (
    <div className="flex justify-center mx-auto pt-10 h-full w-full px-4">
      {isError && (
        <div className="fixed top-0 flex items-center justify-center z-50 h-full w-full bg-red-100">
